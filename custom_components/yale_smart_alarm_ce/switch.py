...
class YaleAlarmSettingSwitch(YaleAlarmEntity, SwitchEntity):
    ...
    @async_handle_errors("turn on alarm setting")
    ...
    @async_handle_errors("turn off alarm setting")
...
class YaleDeviceBooleanSwitch(YaleDeviceEntity, SwitchEntity):
    ...
    @async_handle_errors("enable device setting")
    async def async_turn_on(self, **kwargs: Any) -> None:
        """Enable the setting."""
    ...
    @async_handle_errors("disable device setting")
    async def async_turn_off(self, **kwargs: Any) -> None:
        """Disable the setting."""
        await self.coordinator.async_update_device(
            self._alarm_id, self._device_id,
